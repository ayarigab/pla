...
namespace Ayarigab\Pla\commands;

use Illuminate\Support\Facades\File;
use Illuminate\Console\Command;

class PLAPublish extends Command
{
    /**
     ...
     * @var string
     */
    protected $description = 'Publish Service Worker|Offline Template|manifest file for PWA application.';
    ...
    public function handle()
    {
        ...
        $this->info('Installation is done! Enjoy PLA--Progressive Laravel Apps-- for PWA sites...');
    }
